...
class CreateClubProfileWidget extends StatefulWidget {
  const CreateClubProfileWidget({super.key});

  @override
  State<CreateClubProfileWidget> createState() =>
      _CreateClubProfileWidgetState();
}

class _CreateClubProfileWidgetState extends State<CreateClubProfileWidget> {
