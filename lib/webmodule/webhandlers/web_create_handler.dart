...
import 'package:partymania_owners/screens/splash_screen.dart';
...
class WebCreateHandler extends StatefulWidget {
  final owernerid;
  const WebCreateHandler({super.key, required this.owernerid});

  @override
  State<WebCreateHandler> createState() => _WebCreateHandlerState();
}

class _WebCreateHandlerState extends State<WebCreateHandler> {
