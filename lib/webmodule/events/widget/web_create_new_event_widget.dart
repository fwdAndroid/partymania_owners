...
class WebCreateNewEventWidget extends StatefulWidget {
  const WebCreateNewEventWidget({super.key});

  @override
  State<WebCreateNewEventWidget> createState() =>
      _WebCreateNewEventWidgetState();
}

class _WebCreateNewEventWidgetState extends State<WebCreateNewEventWidget> {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
        ...
        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Container(height: 40, width: 300, child: buildStringList()),
        ),
        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Column(
