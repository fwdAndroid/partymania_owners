...
class UpdateWebEventWidget extends StatefulWidget {
  final uuid;
  final eventName;
  final toEventDate;
  final fromEventDate;
  ...
  @override
  State<UpdateWebEventWidget> createState() => _UpdateWebEventWidgetState();
}

class _UpdateWebEventWidgetState extends State<UpdateWebEventWidget> {
                    ...
                    return Padding(
                      ...
                      child: Container(
                        ...
                        decoration: ShapeDecoration(
                          ...
                          shape: RoundedRectangleBorder(
                            side:
                                BorderSide(width: 1, color: Color(0xFF4E4E4E)),
