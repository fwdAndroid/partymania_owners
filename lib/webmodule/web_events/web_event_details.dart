...
import 'package:partymania_owners/webmodule/web_events/edit_web_event.dart';

class WebEventDetails extends StatefulWidget {
  final uuid;
  final artistType;
  final bird;
  final dayNight;
  ...
  @override
  State<WebEventDetails> createState() => _WebEventDetailsState();
}

class _WebEventDetailsState extends State<WebEventDetails> {
  @override
