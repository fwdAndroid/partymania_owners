...
import 'package:partymania_owners/webmodule/webprofilepages/web_change_password.dart';

class WebMySetting extends StatefulWidget {
  const WebMySetting({super.key});

  @override
  State<WebMySetting> createState() => _WebMySettingState();
}
      ...
      body: Column(
        ...
        children: [
          ...
          ListTile(
            onTap: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (builder) => WebChangePassword()));
            },
            trailing: Icon(
              Icons.keyboard_arrow_right,
              size: 30,
