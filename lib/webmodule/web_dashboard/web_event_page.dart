...
class WebEventsPage extends StatefulWidget {
  const WebEventsPage({super.key});

  @override
  State<WebEventsPage> createState() => _WebEventsPageState();
}

class _WebEventsPageState extends State<WebEventsPage> {
  String selectedDate = '';
  String dateCount = '';
  String range = '';
  String rangeCount = '';
            ...
            Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                    ...
                    color: Colors.white,
                    border:
                        Border.all(color: Color(0xff7B7F91).withOpacity(.4))),
